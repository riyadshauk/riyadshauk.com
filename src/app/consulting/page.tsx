      ...
      <nav className="sticky top-0 z-50 w-full border-b bg-background/95 backdrop-blur supports-[backdrop-filter]:bg-background/60">
        <div className="container flex h-16 items-center justify-between px-4 mobile-container">
          ...
          <div className="flex items-center">
            ...
            <p className="hidden sm:block text-sm text-muted-foreground ml-4">Software Development & Consulting</p>
          </div>
          ...
          <div className="hidden sm:flex items-center space-x-6 text-sm font-medium">
            ...
            <Link href="/#services" className="transition-colors hover:text-foreground/80">Tutoring</Link>
